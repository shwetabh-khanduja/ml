...
def RunNEvaluateExperimentsOnDataSet(classifer_fn,dataset_root,id,metric_calculation_fn,algo_folder,params_to_keep,positive_class,datasets_to_ignore=[],force=False):
